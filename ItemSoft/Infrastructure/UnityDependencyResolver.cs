    ...
    public class UnityDependencyResolver : IDependencyResolver
    {
        ...
        protected virtual void ConfigureContainer(IUnityContainer container)
        {
            ...
            //{
                ...
                ecsbuilder.ProviderConnectionString = "Data Source=localhost;Database=ItemCore;uid=sa;pwd=dani(14131324);";
                ecsbuilder.Metadata = @"res://*/Data.ItemsModel.csdl|res://*/Data.ItemsModel.ssdl|res://*/Data.ItemsModel.msl";
                ...
                container.RegisterType<ItemCoreEntities>(new UnityPerExecutionContextLifetimeManager(), connectionStringParam);
            //}
        }
